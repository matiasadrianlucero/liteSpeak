...
import { blockContact } from "./manageContact/blockContact"
import { deleteContact } from "./manageContact/deleteContact"
...
export function chatUI(map){
    ...
    // // }
    localStorage.setItem("checkId",map[2])

    localStorage.setItem("lastMessageSent","empty")
