...
import { recievedRequests } from "../retrieveRequests/recievedRequests"

import { acceptRequest } from "../actions/acceptRequest"
import { rejectRequest } from "../actions/rejectRequest"
import { blockRequests } from "../actions/blockRequests"
export function displayRecievedRequestsUI(){
    ...
    recievedResults.then(function(recievedData){
        ...
        recievedData.map((recievedMap,index)=>{
            ...
            rejectRequestButton.innerHTML="Deny"
            ...
            blockRequestButton.innerHTML="Block"
